...
data(){
  ...
  methods : {
    inputAssign(insertText){
      ...
      axios
        .get(`https://api.themoviedb.org/3/search/movie?api_key=654289286d1765757140382fe651ed97&language=it-IT&query=${this.resultInput}&page=1&include_adult=false`)
        .then((response) => {
        ...
        axios
          .get(`https://api.themoviedb.org/3/search/tv?api_key=654289286d1765757140382fe651ed97&language=it-IT&query=${this.resultInput}&include_adult=false`)
          .then ((response) =>{
